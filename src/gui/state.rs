...
pub struct Widgets {
    ...
    pub p_color_water_scale:       gtk::Scale,
    pub p_color_vegetation_scale:  gtk::Scale,
    pub p_color_clouds_scale:      gtk::Scale,
...
impl Widgets {
    ...
    pub fn from_builder(
        ...
        Self {
            ...
            p_color_water_scale:      builder.object("p_color_water_scale"     ).expect("Couldn't get p_color_water_scale"     ),
            p_color_vegetation_scale: builder.object("p_color_vegetation_scale").expect("Couldn't get p_color_vegetation_scale"),
            p_color_clouds_scale:     builder.object("p_color_clouds_scale"    ).expect("Couldn't get p_color_clouds_scale"    ),
