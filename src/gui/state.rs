...
impl Widgets {
    ...
    pub fn from_builder(
        ...
        Self {
            ...
            p_color_water_scale:      builder.get_object("p_color_water_scale"     ).expect("Couldn't get p_color_water_scale"     ),
            p_color_vegetation_scale: builder.get_object("p_color_vegetation_scale").expect("Couldn't get p_color_vegetation_scale"),
            p_color_clouds_scale:     builder.get_object("p_color_clouds_scale"    ).expect("Couldn't get p_color_clouds_scale"    ),
            ...
            p_countries_color:        builder.get_object("p_countries_color"       ).expect("Couldn't get p_countries_color"       ),
            p_states_color:           builder.get_object("p_states_color"          ).expect("Couldn't get p_states_color"          ),
            p_lakes_color:            builder.get_object("p_lakes_color"           ).expect("Couldn't get p_lakes_color"           ),
